...
class NullHash extends Hash {
    ...
    constructor() {
        ...
        NullHash.singleton = super(NullHash.bytes);
        return NullHash.singleton;
    }
...
class UnitHash extends Hash {
    ...
    constructor() {
        ...
        UnitHash.singleton = super(UnitHash.bytes);
        return UnitHash.singleton;
    }
...
"undefined"!==typeof module&&module.exports&&(module.exports=sjcl);"function"===typeof define&&define([],function(){return sjcl;});"undefined"===typeof ArrayBuffer&&function(a){a.ArrayBuffer=function(){};a.DataView=function(){};}(this);
